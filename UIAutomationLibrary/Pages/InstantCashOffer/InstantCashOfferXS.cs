...
{
    public class InstantCashOfferXS : InstantCashOfferAbstract
    {
        public InstantCashOfferXS(IWebDriver driver, Viewport viewport, Language language) : base(driver, viewport, language) { }
        ...
        public void ClickNextBtnOnIcoLeadDWW(By locator, string locatorValue = null, bool scrollIntoView = false, int timeOut = 30)
        {
            IWebElement element = FindElement(locator);
            if (scrollIntoView) { ScrollTo(element); }
        ...
        public override void EnterYmmtDetails(IcoLeadForm icoLeadForm)
        {
            ...
            ScrollTo(FindElement(yearLocator));
            ...
            ScrollTo(FindElement(modelLocator));
        ...
        public override void EnterVinDetails(IcoLeadForm icoLeadForm)
        {
            ...
            ScrollTo(FindElement(vinLocator));
        ...
        public override void EnterVinDetailsDWW(IcoLeadForm icoLeadForm)
        {
            ...
            while (!IsValidVin(icoLeadForm))
            {
                ...
                if (counter > 3 && !IsValidVin(icoLeadForm))
                {
                    throw new Exception("Unable to generate random valid VIN");
                }
            }
            ...
            ClickNextBtnOnIcoLeadDWW(nextBasicDetailBtnLocator, InstantCashOfferLocators.DWWLocators.IcoNextBtn.GetAttribute<DescriptionAttribute>().Description, scrollIntoView: true);
        }
        ...
        public override void EnterVehicleDetails(IcoLeadForm icoLeadForm)
        {
            ...
            FocusElementJS(FindElement(kilometerLocator));
            EnterTextWithLoadOnIcoLead(kilometerLocator, icoLeadForm.Kilometers);
            UnFocusElementJS(FindElement(kilometerLocator));
            WaitForIcoModalProgress();
            ...
            SelectIcoAnswer(ownershipAnsLocators, icoLeadForm.IcoQuestionnaireAnswers[IcoLeadForm.IcoQuestionnaire.IsOriginalOwner], icoLeadForm: icoLeadForm, scrollIntoView: true);
            ...
            {
                SelectIcoAnswer(icoVehicleReplacementAnsLocators, icoLeadForm.IcoQuestionnaireAnswers[IcoLeadForm.IcoQuestionnaire.IsVehicleReplacement], icoLeadForm: icoLeadForm, scrollIntoView: true);
            }
        ...
        public override void EnterVehicleDetailsDWW(IcoLeadForm icoLeadForm)
        {
            ...
            EnterTextWithLoadOnIcoLead(kilometerLocator, icoLeadForm.Kilometers, true);
            ...
            SelectIcoAnswer(ownershipAnsLocators,
                icoLeadForm.IcoQuestionnaireAnswers[IcoLeadForm.IcoQuestionnaire.IsOriginalOwner],icoLeadForm, scrollIntoView: true,
            ...
            ClickNextBtnOnIcoLeadDWW(nextConditionBtnLocator, InstantCashOfferLocators.DWWLocators.IcoNextBtn.GetAttribute<DescriptionAttribute>().Description, scrollIntoView: true);
        }
        ...
        public override void EnterVehicleConditions(IcoLeadForm icoLeadForm)
        {
            ...
            SelectIcoAnswer(hasLightAnsLocators, icoLeadForm.IcoQuestionnaireAnswers[IcoLeadForm.IcoQuestionnaire.HasWarningLight], icoLeadForm: icoLeadForm, scrollIntoView: true);
            ...
            SelectIcoAnswer(hasModAnsLocators, icoLeadForm.IcoQuestionnaireAnswers[IcoLeadForm.IcoQuestionnaire.HasModification], icoLeadForm: icoLeadForm, scrollIntoView: true);
            ...
            SelectIcoAnswer(hasOdorAnsLocators, icoLeadForm.IcoQuestionnaireAnswers[IcoLeadForm.IcoQuestionnaire.HasOdor], icoLeadForm: icoLeadForm, scrollIntoView: true);
            ...
            SelectIcoAnswer(hasOtherIssueAnsLocators, icoLeadForm.IcoQuestionnaireAnswers[IcoLeadForm.IcoQuestionnaire.HasOtherIssue], icoLeadForm: icoLeadForm, scrollIntoView: true);
        ...
        public override void EnterVehicleConditionsDWW(IcoLeadForm icoLeadForm)
        {
            ...
            SelectIcoAnswer(hasOtherIssueAnsLocators, icoLeadForm.IcoQuestionnaireAnswers[IcoLeadForm.IcoQuestionnaire.HasOtherIssue],
                 locatorValue: InstantCashOfferLocators.DWWLocators.IcoVehicleOtherIssuesAns.GetAttribute<DescriptionAttribute>().Description,
                  icoLeadForm :icoLeadForm, scrollIntoView: true);
            ClickNextBtnOnIcoLeadDWW(nextContactBtnLocator, locatorValue: InstantCashOfferLocators.DWWLocators.IcoNextBtn.GetAttribute<DescriptionAttribute>().Description, scrollIntoView: true);
        }
        ...
        public override void EnterCustomerDetails(IcoLeadForm icoLeadForm)
        {
            ...
            EnterTextWithLoadOnIcoLead(icoEmailLocator, icoLeadForm.Email, true);
            ...
            ScrollTo(FindElement(icoContactTimeLocator));
            ...
            {
                ScrollTo(FindElement(icoSellWhenLocator));
        ...
        public override void EnterCustomerDetailsDWW(IcoLeadForm icoLeadForm)
        {
            ...
            ClickNextBtnOnIcoLeadDWW(nextIcoBtnLocator, locatorValue: InstantCashOfferLocators.DWWLocators.IcoNextBtn.GetAttribute<DescriptionAttribute>().Description, scrollIntoView: true);
        }
