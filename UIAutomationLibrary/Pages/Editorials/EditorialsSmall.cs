...
{
    public class EditorialsSmall : EditorialsAbstract
    {
        public EditorialsSmall(IWebDriver driver, Viewport viewport, Language language) : base(driver, viewport, language) { }
