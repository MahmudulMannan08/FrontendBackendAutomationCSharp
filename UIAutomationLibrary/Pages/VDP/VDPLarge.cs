...
{
    public class VDPLarge : VDPAbstract
    {
        public VDPLarge(IWebDriver driver, Viewport viewport, Language language) : base(driver, viewport, language) { }
        ...
        public override void OpenLeadAbs(EmailLeadForm.EmailLeads emailLeads)
        {
            ...
            switch (emailLeads)
            {
                ...
                case EmailLeadForm.EmailLeads.GalleryLead:
                    ClickElement(FindElement(By.CssSelector(VDPLocators.LargeLocators.MainImage.GetAttribute<DescriptionAttribute>().Description)));
                    WaitForModalToOpen(By.CssSelector(VDPLocators.CommonLocators.GalleryModal.GetAttribute<DescriptionAttribute>().Description));
                    break;
        ...
        {
            IWebElement element = FindElement(By.CssSelector(VDPLocators.LargeLocators.DepositTerms.GetAttribute<DescriptionAttribute>().Description + " input"));
            if (IsCheckboxChecked(element) != toBeChecked)
            {
                ClickElement(FindElement(By.CssSelector(VDPLocators.LargeLocators.DepositTerms.GetAttribute<DescriptionAttribute>().Description + " span")));
            }
        }
        #endregion
        ...
        {
            return IsElementVisible(By.CssSelector(VDPLocators.LargeLocators.ViewMapButton.GetAttribute<DescriptionAttribute>().Description));
        }
        public override void ClickOnViewMapButton()
        {
            IWebElement element = FindElement(By.CssSelector(VDPLocators.LargeLocators.ViewMapButton.GetAttribute<DescriptionAttribute>().Description));
            ScrollTo(element);
            ClickElement(element);
            WaitForModalToOpen(By.CssSelector(VDPLocators.CommonLocators.ViewMapModal.GetAttribute<DescriptionAttribute>().Description));
        }
        public override bool IsDealerInfoViewAllInventoryButtonDisplayed()
        {
            return IsElementVisible(By.CssSelector(VDPLocators.LargeLocators.DealerInfoViewAllInventoryBtn.GetAttribute<DescriptionAttribute>().Description));
        }
        public override bool IsDealerInfoShowmapButtonDisplayed()
        {
            return IsElementVisible(By.CssSelector(VDPLocators.LargeLocators.DealerInfoShowMapBtn.GetAttribute<DescriptionAttribute>().Description));
        }
        public override void ClickOnViewAllInventoryButton()
        {
            IWebElement element = FindElement(By.CssSelector(VDPLocators.LargeLocators.DealerInfoViewAllInventoryBtn.GetAttribute<DescriptionAttribute>().Description));
            ScrollTo(element);
            ClickElement(element);
        }
        public override void ClickOnShowmapButton()
        {
            IWebElement element = FindElement(By.CssSelector(VDPLocators.LargeLocators.DealerInfoShowMapBtn.GetAttribute<DescriptionAttribute>().Description));
            ScrollTo(element);
            ClickElement(element);
            WaitForModalToOpen(By.CssSelector(VDPLocators.CommonLocators.ViewMapModal.GetAttribute<DescriptionAttribute>().Description));
        }
        public override bool IsDealerInfoAwardWinnerLogoDisplayed()
        {
            return IsElementVisible(By.CssSelector(VDPLocators.LargeLocators.DealerInfoAwardWinnerLogo.GetAttribute<DescriptionAttribute>().Description));
        }
