...
{
    public class InstantCashOfferSmall : InstantCashOfferAbstract
    {
        public InstantCashOfferSmall(IWebDriver driver, Viewport viewport, Language language) : base(driver, viewport, language) { }
        ...
        public override void ClickNextBtnOnIcoLead(By locator, string locatorValue = null, bool scrollIntoView = false, int timeOut = 30)
        {
            ...
            ClickElementJS(locator.Criteria);
        ...
        public override void EnterVinDetailsDWW(IcoLeadForm icoLeadForm)
        {
            ...
            System.Threading.Thread.Sleep(2000);
            ClickNextBtnOnIcoLead(nextBasicDetailBtnLocator, InstantCashOfferLocators.DWWLocators.IcoNextBtn.GetAttribute<DescriptionAttribute>().Description);
        }
        ...
        public override void EnterVehicleDetails(IcoLeadForm icoLeadForm)
        {
            ...
            EnterTextUsingJS(kilometerLocator, icoLeadForm.Kilometers);
            ...
            EnterText(postalCodeLocator, icoLeadForm.PostalCode);
        ...
        public override void EnterVehicleConditions(IcoLeadForm icoLeadForm)
        {
            ...
            ClickNextBtnOnIcoLead(nextContactBtnLocator);
        }
        ...
        public override void EnterCustomerDetails(IcoLeadForm icoLeadForm)
        {
            ...
            ClickNextBtnOnIcoLead(nextIcoBtnLocator);
        }
        ...
        public override void EnterIncorrectVinDetails()
        {
            for (int i = 0; i < 3; i++)
            {
                ...
                UnFocusElementJS(FindElement(vinLocator),3);
                WaitForIcoModalProgress();
